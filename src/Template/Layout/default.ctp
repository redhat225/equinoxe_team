                        ...
                        <div class="col s12 white-text" style="position: absolute; width: 100%; top:40%;">
                          <div class="container">
                               <div class="container hide-on-small-and-down center" >
                                    <h1 class="mg-size-50"> <span class="light"> L'Equipe </span>
                                      <span
                                         class="txt-rotate bold"
                                         data-period="2000"
                                         data-rotate='[ "Multiservice", "Multitâche", "Multipôle", "Multifun"]' style="border-bottom: 5px solid #fc00ff;"></span>
                                    </h1>
                                    <h2 class="mg-size-50">
                                      <span class="light">A vos</span>  <span class="bold" style="border-bottom: 5px solid #7a80a1;">Besoins</span>
                                    </h2>
                                    
                                    <h2 class="mg-size-50"><span class="light">De</span> <span class="bold" style="border-bottom: 5px solid #f9f461;">tous les jours</span></h2>
                               </div>
                          </div>
