...
<div class="row center mg-padding-50 grey lighten-4">
	...
	<div class="row center mg-padding-50">
		    <h6 class="mg-size-25 bold">Notre Mission, Votre Bien-être</h6>
	         <?= $this->Html->image('assets/buble.png',['style'=>'width:50px;']) ?>
	        <h6 class="mg-size-18" style="padding-left:13%;padding-right: 13%;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos nemo error eius soluta est ipsum excepturi voluptatum facere earum voluptatibus.</h6>

		<div class="col s4 mg-margin-top-40">
	...
	<div class="parallax-container mg-height-700">
		...
		<div class="row" style="position: absolute;right:0;">
		    <div class="container">
		       <div class="container right left-align">
		                             <div class="row">
								         <form name="loginForm" ng-submit="loginctrl.login(user)" ng-hide="loginctrl.loader">
								         	<h6 class="mg-padding-left-10 mg-size-30 bold left-align white-text mg-padding-top-20">
											 Notre Equipe vous recontacte <br> en 2 minutes chrono!
											</h6>
				 							<?= $this->Html->image('assets/buble.png',['style'=>'width:50px;','class'=>'mg-padding-left-10']) ?>
						                	<div class="col s12 input-field">
						                		<input type="text" ng-pattern="/^[a-zA-Z0-9_]{8,30}$/" ng-model="user.username" required class="white grey-text text-darken-2 mg-padding-10 login-input mg-height-45" ng-minlength="8"  name="username" id="username" style="border-radius:2px;" placeholder="Nom Complet">
						                	</div>

						              		<div class="col s12 mg-margin-0 input-field">
						                		<input type="text" ng-pattern="/^[a-zA-Z0-9_]{8,30}$/" ng-model="user.username" required class="white grey-text text-darken-2 mg-padding-10 login-input mg-height-45" ng-minlength="8"  name="username" id="username" style="border-radius:2px;" placeholder="Numéro de Téléphone">
						                	</div>

						                	<div class="col s12 mg-margin-0 input-field">
						                		<input type="text" ng-pattern="/^[a-zA-Z0-9_]{8,30}$/" ng-model="user.username" required class="white mg-padding-10 login-input mg-height-45" ng-minlength="8"  name="username" id="username" style="border-radius:2px;" placeholder="E-mail">
						                	</div>

						                	<div class="col s12 mg-margin-0 input-field">
						                		<input ng-model="user.password" ng-minlength="8" required ng-pattern="/^[a-zA-Z0-9_@\#\$\.]{8,30}$/" class="white grey-text text-darken-2 mg-padding-10 login-input mg-height-45" name="password" id="password" type="password" style="border-radius:2px;" placeholder="Disponibilité">
						             ...
						             <div class="row mg-margin-0">
									      <div class="col s4 mg-padding-top-10 mg-padding-left-0 mg-padding-bottom-10">
											    <button ng-disabled="loginForm.$invalid" class="btn mg_prim_background white-text bold" style="width: 100%;">Souscrire</button> 
										   </div>
				                     </div>

				                           <div class="row mg-padding-left-0 mg-margin-0">
												<div class="col s12 mg-padding-top-10 mg-padding-left-0 mg-padding-bottom-10">
											      <h6 class="mg-size-15 left-align white-text">
