...
<!-- Equinoxe description -->
		<div class="row center mg-padding-40 mg-margin-0 yellow">
			<div class="container" style="width: 72%;">
				<?= $this->Html->image('assets/event/equinoxe_logo.png',['class'=>'mg-width-200']) ?>
			...
			<ul>
				<li class="mg-margin-top-30" data-aos="fade-down">
				   <div class="row center">
				   	  ...
				   	  <div class="col s9 left-align"> 
				   	  		<h6 class="bold mg_sec_color_4 mg-size-17">Une communication certaine</h6>
				...
				<li class="mg-margin-top-30" data-aos="fade-down">
				  <div class="row center">
				   	  ...
				   	  <div class="col s9 left-align"> 
				   	  		<h6 class="bold mg_sec_color_4 mg-size-17">Une équipe innovante</h6>
...
<div class="row center mg-padding-bottom-150 mg-padding-top-50 white-text parallax-container mg-margin-bottom-0" style="height:auto !important;">
    ...
    <h4 class="">Commandez votre évènement</h4>
    <h4 class="bold">En 3 étapes! <br>
